        ...
        try {
            ...
            if ($contador == 0) {
                ...
                if (!empty($V_PREG) && isset($V_PREG)) {
                    $query .= "A.CJPRE_DESCRIPCION LIKE %'" . $V_PREG . "'% AND ";
                }
                ...
                if (isset($_POST["order"])) {
                    ...
                    $query .= 'ORDER BY A.NJPRE_ORDEN ASC ';
                }
                $query1 = '';
                if ($_POST["length"] != -1) {
                ...
                while($row = $result->fetch_assoc()) {
                    $sub_array = array();
                    $sub_array[] = $row["NJPRE_ID"];                                                    //[0]
                    $sub_array[] = $row["NJPRE_ORDEN"];                                                 //[1]
                    $sub_array[] = $row["CJPRE_DESCRIPCION"];                                           //[2]
                    $sub_array[] = $row["CJCAP_NOMBRE"];                                                //[3]
                ...
                function get_all_data($connect) {
                    ...
                    $query2 = "SELECT COUNT(DISTINCT A.NJPRE_ID) AS TOTAL
                                FROM SRD_JCI_PREGUNTAS A 
