        ...
        try {
            ...
            if ( $V_PERI === NULL || $V_PERI == '' ) {
                ...
                $stmt = $conn->prepare("SELECT DISTINCT 
                                        ...
                                        WHERE C.NUSUA_ID = ? AND A.NHPER_ID = ? AND
                                            B.NHPER_ESTADO = 1 AND B.NAUDI_EST_REG = 1 AND 
            ...
            if ( $V_SERV === NULL || $V_SERV == '' ) {
                ...
                $stmt = $conn->prepare("SELECT DISTINCT 
                                        ...
                                        WHERE A.NHPER_ID = ? AND A.CAREA_ID = ? AND 
                                            A.NHENC_ESTADO = 1 AND A.NAUDI_EST_REG = 1 AND 
            ...
            if ($contador == 0) {
                ...
                $query .= " A.NHENC_ESTADO = 1 AND A.NAUDI_EST_REG = 1 
