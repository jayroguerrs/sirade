    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        try {
            ...
            if ( $V_PERI === NULL || $V_PERI == '' ) {
                ...
                $stmt = $conn->prepare("SELECT NHPER_ID FROM SRD_HIG_PERIODO WHERE CHPER_DESCRIPCION = ? AND NHPER_ID <> ? AND NAUDI_EST_REG = 1;");
            ...
            if ($contador == 0) {
                ...
                $stmt = $conn->prepare("UPDATE SRD_HIG_PERIODO
                                        SET CHPER_DESCRIPCION = ?, DHPER_INICIO = ?, DHPER_FIN = ?, NHPER_ESTADO = ?, DAUDI_REG_UPD = CURRENT_TIMESTAMP(), NAUDI_REG_UPD = ?
                                        WHERE NHPER_ID = ? ;");
