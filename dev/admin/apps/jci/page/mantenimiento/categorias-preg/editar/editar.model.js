...
var KTCategoriaPregList = function() {
    ...
    var initDatatable1 = function() {
        dt1 = $("#tb_categorias").DataTable({
            ...
            ajax: {
                type: "POST",
                url: `${environment.apiSRD}/API/jci/preguntas-cat/lista`,
                data: function (d) {
            ...
            columns: [
                ...
                { data: 0, name: 'NJCAP_ID' },
                { data: 1, name: 'NJCAP_ORDEN' },
                { data: 2, name: 'CJCAP_NOMBRE' },
                { data: 3, name: 'ESTADO' },
            ...
            buttons: [
                {
                  ...
                  buttons: [
                    ...
                    },
                    {
                      ...
                      action: newexportaction,
                      exportOptions: { columns: [1, 2, 3, 4, 5, 6] },
                      filename: "Reporte de Categorías de Preguntas"
                    },
                    {
                      extend: 'excel',
                      ...
                      action: newexportaction,
                      exportOptions: { columns: [1, 2, 3, 4, 5, 6] },
                      ffilename: "Reporte de Categorías de Preguntas"
                    },
                    {
                      extend: "pdf",
