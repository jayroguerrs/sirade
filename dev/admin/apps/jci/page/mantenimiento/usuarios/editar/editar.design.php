    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
        ...
        <div class="card" id="div-periodos">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <div>
                            <button type="button" class="btn btn-light-primary me-3" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-attach="parent">
            ...
            <div class="card-body pt-0">
                ...
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-7 gy-5 gs-7" id="tb_usuarios">
                    <!--begin::Table head-->
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-8 px-7 text-uppercase">
                            <th class="min-w-80px">Acciones</th>
                            <th>Key</th>
                            <th class="min-w-100px">Codigo</th>
                            <th class="min-w-180px">Documento</th>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="fv-row mb-7 col-md-6">
                                            ...
                                            <select class="form-select form-select-solid mb-2" name="rol" data-control="select2"
                                                    data-placeholder="Seleccione un rol" data-allow-clear="true" data-dropdown-parent="#kt_modal_agregar_usuario">
                                                <option></option>
                                                <?php
                                                    $sql = "SELECT DISTINCT 
                                                                A.NROLE_ID,
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_usuario_filtro_modal_scroll" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid mb-2" name="filtro-nacionalidad" data-control="select2"
                                            data-placeholder="Seleccione un nacionalidad" data-allow-clear="true" data-dropdown-parent="#kt_usuario_filtro_modal">
                                        <option></option>
                                        <?php
                                            $sql = "SELECT DISTINCT 
                                                        A.NNACI_ID,
