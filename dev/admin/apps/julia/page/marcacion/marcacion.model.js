            ...
            formMarcacion,
            {
                fields: {
                    'codigo-colaborador': {
                        validators: {
                            notEmpty: {
                                message: 'El nombre de la compania es requerida'
                            },
                            regexp: {
                                regexp: /^[0-9]{7}$/,
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        datos.append('fecha_hora', '2024-05-01 13:10:00');
                        ...
                        .then(datos => {
                            if (datos.estado == 1) {
                                ...
                                document.getElementById('lbl-hora').innerText = datos.data.hora == undefined ? '---' : moment(datos.data.hora).format('DD/MM/YYYY HH:mm:ss a');
