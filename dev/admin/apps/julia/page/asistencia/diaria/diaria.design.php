    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
        ...
        <div class="card" id="div-periodos">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                            data-bs-target="#kt_diario_filtro_modal">
            ...
            <div class="card-body">
                ...
                <!--begin::No Records Message-->
                <div id="noRecordsMessage" style="display: none; text-align: center; margin-top: 20px;">
                    No se han encontrado registros con los valores filtrados.
                </div>
        ...
        <!--begin::Modals-->
        <!--begin::Modal - Filtros-->
        <div class="modal fade" id="kt_diario_filtro_modal" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-850px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="#" id="form_modal_filtro_diario">
                        <!--begin::Modal header-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_diario_filtro_modal_scroll" data-kt-scroll="true"
                                data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                                data-kt-scroll-dependencies="kt_diario_filtro_modal_header"
                                data-kt-scroll-wrappers="#kt_diario_filtro_modal_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid mb-2" name="filtro-periodos" data-control="select2"
                                            data-placeholder="Seleccione un periodo" data-allow-clear="true" data-dropdown-parent="#kt_diario_filtro_modal">
                                    </select>
                                    <!--end::Select2-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid mb-2" name="filtro-ocupacion" data-control="select2"
                                            data-placeholder="Seleccione una ocupación" data-allow-clear="true" data-dropdown-parent="#kt_diario_filtro_modal">
                                        <option></option>
                                        <?php
                                            $sql = "SELECT 
                                                        A.NOCUP_ID,
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid mb-2" name="filtro-desempenio" data-control="select2"
                                            data-placeholder="Seleccione un desempeño" data-allow-clear="true" data-dropdown-parent="#kt_diario_filtro_modal">
                                        <option></option>
                                        <?php
                                            $sql = "SELECT 
                                                        A.NDESE_ID,
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid mb-2" name="filtro-areaperiodo" data-control="select2"
                                            data-placeholder="Seleccione un área" data-allow-clear="true" data-dropdown-parent="#kt_diario_filtro_modal">
                                        <option></option>
                                        <?php
                                            $sql = "SELECT 
                                                        A.CAREA_ID,
                                ...
                                <div class="fv-row mb-7">
                                    <!--begin::Label-->
                                    <label class="required fs-6 fw-semibold mb-2">Tipo de Turno</label>
                                    <!--end::Label-->

                                    <div class="form-check form-check-custom form-check-solid my-4">
                                        <input class="form-check-input" type="checkbox" value="M" id="op_manana" name="filtro-tipo" />
                                        <label class="form-check-label" for="op_manana">
                                            MAÑANA
                                        </label>
                                    </div>

                                    <div class="form-check form-check-custom form-check-solid my-4">
                                        <input class="form-check-input" type="checkbox" value="T" id="op_tarde" name="filtro-tipo"/>
                                        <label class="form-check-label" for="op_tarde">
                                            TARDE
                                        </label>
                                    </div>

                                    <div class="form-check form-check-custom form-check-solid my-4">
                                        <input class="form-check-input" type="checkbox" value="N" id="op_noche" name="filtro-tipo"/>
                                        <label class="form-check-label" for="op_noche">
                                            NOCHE
                                        </label>
                                    </div>
                                </div>
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_filtro_diario_limpiar" class="btn btn-light me-3" data-bs-dismiss="modal">
                                Limpiar
                            </button>
                            <!--end::Button-->

                            <!--begin::Button-->
                            <button type="button" id="kt_modal_filtro_diario_submit" class="btn btn-primary">
