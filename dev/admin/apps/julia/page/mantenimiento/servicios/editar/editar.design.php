...
<div id="kt_app_content" class="app-content  flex-column-fluid ">
    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <div>
                            <button type="button" class="btn btn-light-primary me-3" id="boton-exportar-servicio">
        ...
        <!--begin::Modals-->
        <!--begin::Modal - Agregar Editar - Servicio-->
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_agregar_servicio_scroll" data-kt-scroll="true"
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="fv-row mb-7">
                                        <!--begin::Label-->
                                        <label class="required fs-6 fw-semibold mb-2">ID Servicio</label>
                                        <!--end::Label-->

                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="Ingrese un ID de servicio" name="servicio" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <!--begin::Input-->
                                        <input class="form-control form-control-solid" placeholder="Ingrese una descripción de servicio" name="descripcion" />
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_servicio_filtro_modal_scroll" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Ingrese un ID de servicio" name="filtro-servicio" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <!--begin::Input-->
                                    <input class="form-control form-control-solid" placeholder="Ingrese una descripción de servicio" name="filtro-descripcion" />
                                    <!--end::Input-->
                                </div>
                                <!--end::Input group-->
