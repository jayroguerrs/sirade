...
<div id="kt_app_content" class="app-content  flex-column-fluid ">
    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
            ...
            <div class="card-header border-0 pt-6">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <!--begin::Add customer-->
                        <a type="button" class="btn btn-primary" href="javascript:AbrirModalServicio(null, null, 'agregar')">
                ...
                <table class="table align-middle table-row-dashed fs-7 gy-5 gs-7" id="tb_periodos">
                    ...
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-8 px-7 text-uppercase">
                            ...
                            <th class="min-w-180px">Servicio</th>
                            <th class="min-w-175px">Supervisor</th>
        ...
        <!--begin::Modals-->
        <!--begin::Modal - Agregar - Servicio-->
        <div class="modal fade" id="kt_modal_agregar_servicio" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-850px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    <!--begin::Form-->
                    <form class="form" action="#" id="form_modal_agregar_servicio">
                        <!--begin::Modal header-->
                        <div class="modal-header" id="kt_modal_agregar_servicio_header">
                            <!--begin::Modal title-->
                            <h2 class="fw-bold" id="titulo_modal" >Añadir un Servicio</h2>
                            <!--end::Modal title-->
                        ...
                        <div class="modal-body py-10 px-lg-17">
                            <!--begin::Scroll-->
                            <div class="scroll-y me-n7 pe-7" id="kt_modal_agregar_servicio_scroll" data-kt-scroll="true"
                                data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto"
                                data-kt-scroll-dependencies="#kt_modal_agregar_servicio_header"
                                data-kt-scroll-wrappers="#kt_modal_agregar_servicio_scroll" data-kt-scroll-offset="300px">
                                ...
                                <div class="mb-5">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <select class="form-select form-select-solid mb-2" name="servicio" data-control="select2"
                                                data-placeholder="Seleccione un servicio" data-allow-clear="true" data-dropdown-parent="#kt_modal_agregar_servicio" disabled>
                                            <option></option>
                                            <?php
                                                $sql = "SELECT DISTINCT 
                                                            A.CAREA_ID,
                        ...
                        <div class="modal-footer flex-center">
                            <!--begin::Button-->
                            <button type="reset" id="kt_modal_agregar_servicio_cancel" class="btn btn-light me-3" data-bs-dismiss="modal">
                                Cancelar
                            </button>
                            <!--end::Button-->

                            <!--begin::Button-->
                            <button type="submit" id="kt_modal_agregar_servicio_submit" class="btn btn-primary">
                ...
                <div class="modal-content">
                    ...
                    <form class="form" action="#" id="form_modal_filtro_servicio">
                            ...
                            <div class="scroll-y me-n7 pe-7" id="kt_servicio_filtro_modal_scroll" data-kt-scroll="true"
                                ...
                                <div class="fv-row mb-7">
                                    ...
                                    <select class="form-select form-select-solid mb-2" name="filtro-servicio" data-control="select2"
                                            data-placeholder="Seleccione un servicio" data-allow-clear="true" data-dropdown-parent="#kt_servicio_filtro_modal">
                                        <option></option>
                                        <?php
                                            $sql = "SELECT DISTINCT 
                                                        A.CAREA_ID,
                        ...
                        <div class="modal-footer flex-center">
                            ...
                            <!--begin::Button-->
                            <button type="button" id="kt_modal_filtro_servicio_submit" class="btn btn-primary">
                                <span class="indicator-label">
                                    Filtrar
                                </span>
                                <span class="indicator-progress">
