...
var KTPersonalList = function() {
    ...
    var initDatatable1 = function() {
        ...
        dt1 = $("#tb_periodos").DataTable({
            ...
            ajax: {
                type: "POST",
                url: `${environment.apiSRD}/API/higiene/servicios/lista`,
                data: function (d) {
                    ...
                    if (status == 'Valid') {
                        ...
                        Swal.fire({
                            ...
                            if (result.value) {
                                ...
                                fetch(`${environment.apiSRD}/API/higiene/servicios/${apimode}-servicios`, {
                                    method: 'POST',
                                    body: datos
...
function AbrirModalServicio(id, modo) {
    ...
    if (modo == 'editar') {
        ...
        fetch(`${environment.apiSRD}/API/higiene/servicios/obtener-por-id`, {
            method: 'POST',
            body: datos
        }).then(Response => Response.json())
        .then(datos => {
...
function EliminarServicio(id) {    
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            fetch(`${environment.apiSRD}/API/higiene/servicios/eliminar-servicios`, {
                method: 'POST',
                body: datos
            }).then(Response => Response.json())
            .then(datos => {
