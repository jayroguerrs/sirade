...
var KTEvaluacion = function() {
    ...
    var initDatatable1 = function() {
        ...
        dt1 = $("#tb_periodos").DataTable({
            ...
            ajax: {
                type: "POST",
                url: `${environment.apiSRD}/API/higiene/encuestas/lista-periodo`,
                data: function(d){
            ...
            columns: [
              { data: 0, name: 'NHPER_ID' },
              { data: 1, name: 'CHPER_DESCRIPCION' },
              { data: 2, name: 'DHPER_INICIO' },
              { data: 3, name: 'DHPER_FIN' },
              { data: 4, name: 'ESTADO' },
