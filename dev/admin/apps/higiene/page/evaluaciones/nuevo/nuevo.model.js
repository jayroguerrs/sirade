...
var KTNuevaEvaluacion = function () {
                    ...
                    if (status == 'Valid') {
                        ...
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                fetch(`${environment.apiSRD}/API/higiene/encuestas/agregar-respuesta`, {
                                    method: 'POST',
                                    body: formData,
                                }).then(Response => Response.json())
                                .then(datos => {
    ...
    function listarServicios () {
        ...
        fetch(`${environment.apiSRD}/API/higiene/encuestas/combo-servicios?${queryString}`, {
            method: 'GET',
        }).then(Response => Response.json())
        .then(datos => {
            if (datos.estado == 1) {
    ...
    function listarColaboradores () {
        ...
        fetch(`${environment.apiSRD}/API/higiene/encuestas/combo-colaborador?${queryString}`, {
            method: 'GET',
        }).then(Response => Response.json())
        .then(datos => {
            if (datos.estado == 1) {
