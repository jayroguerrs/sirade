...
function AbrirApp() {
    var pagina = window.location.href.split('?')[0] + '?app=' + $("#select-app").val();
    // Abrir nuevo tab
...
function msgConfirm(text, callBackOk, callBackError) {
    Swal.fire({
        html: text,
        icon: 'question',
...
function msgError(text, callBack, callBackError) {
    Swal.fire({
        title: 'Error',
        icon: 'error',
        html: text,
...
function msgWarning(text, confirmTexto, callBackOk, callBackError) {
    Swal.fire({
        //title: title,
        icon: 'warning',
        html: text,
...
function msgLoad(text, callBack) {
    Swal.fire({
        title: '',
        html: text,
        allowOutsideClick: false,
...
function msgSuccess(title, text, callBack) {
    Swal.fire({
        title: title,
        icon: 'success',
        html: text,
...
function msgErrorNormal(title, text, callBack) {
    Swal.fire({
        title: title,
        icon: 'error',
        html: text,
...
function msgSuccessMixin(titulo, texto) {
...
function msgWarningMixin(titulo, texto) {
...
function msgAutoClose() {
    Swal.close();
}

function SuccessMensaje(data) {
