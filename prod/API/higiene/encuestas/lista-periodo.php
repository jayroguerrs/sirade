        ...
        try {
            ...
            if ($contador == 0) {
                ...
                $query = " SELECT
                            ...
                            LEFT JOIN SRD_CATALOGO_DETALLE Z ON Z.NCATA_ID = 11 AND Z.CCADE_CODIGO = A.NHPER_ESTADO
                ...
                if (isset($_POST["search"]["value"])) {
                    ...
                    $query .= 'OR Z.CCADE_NOMBRE LIKE LIKE "%' . $_POST["search"]["value"] . '%") ';
                }
                
                $query .= " GROUP BY B.CHPER_DESCRIPCION  ";
                ...
                function get_all_data($connect, $V_ID, $V_ROL)
                {
                    ...
                    //Filtros de Busqueda personalizados
                    if (!empty($V_ID) && isset($V_ID) && $V_ROL != 1) {
                        $query2 .= "AND B.NHENC_SUPERVISOR = " . $V_ID . " ";
                    }
                    //Fin Filtros de Busqueda personalizados
