        ...
        try {
            ...
            if ($contador == 0) {
                ...
                $query = " SELECT
                                ...
                                A.CHCAP_NOMBRE,
                                A.NHCAP_ORDEN,
                                FN_OBTENER_NOMBRE_ESTADO(A.NHCAP_ESTADO) ESTADO,
                ...
                if (!empty($V_ESTA) && isset($V_ESTA) || $V_ESTA == '0') {
                    $query .= "A.NHCAP_ESTADO = " . $V_ESTA . " AND ";
                }
                ...
                if (isset($_POST["search"]["value"])) {
                    $query .= '(A.CHCAP_NOMBRE LIKE "%' . $_POST["search"]["value"] . '%" ';
                    $query .= 'OR FN_OBTENER_NOMBRE_ESTADO(A.NHCAP_ESTADO) LIKE "%' . $_POST["search"]["value"] . '%") ';
                }
                ...
                if (isset($_POST["order"])) {
                    ...
                    $query .= 'ORDER BY A.NHCAP_ORDEN ASC ';
                }
                $query1 = '';
                if ($_POST["length"] != -1) {
                ...
                while($row = $result->fetch_assoc()) {
                    $sub_array = array();
                    $sub_array[] = $row["NHCAP_ID"];                                                    //[0]
                    $sub_array[] = $row["NHCAP_ORDEN"];                                                 //[1]
                    $sub_array[] = $row["CHCAP_NOMBRE"];                                                //[2]
                ...
                function get_all_data($connect) {
                    ...
                    $query2 = "SELECT COUNT(DISTINCT A.NHCAP_ID) AS TOTAL
                                FROM SRD_HIG_CATEGORIA_PREG A 
