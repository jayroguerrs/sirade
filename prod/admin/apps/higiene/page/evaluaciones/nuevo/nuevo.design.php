        ...
        <form id="formEvaluacion" class="form d-flex flex-column flex-lg-row"
            ...
            <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                    ...
                                    <select class="form-select mb-2" name="periodo" data-control="select2" data-kt-nueva-evaluacion="opciones" 
                                        ...
                                        <?php
                                            $sql = "SELECT DISTINCT 
                                                    ...
                                                    GROUP BY B.DHPER_FIN DESC;";
                                            $result = $conn->query($sql);
                                            if ($result->num_rows > 0) {
                                                // output data of each row
                                                while($row = $result->fetch_assoc()) { ?>
                                                    <option value="<?php echo $row["NHPER_ID"]; ?>"><?php echo $row["CHPER_DESCRIPCION"]; ?></option> <?php
                                                }
                                            }
                                        ?>
                                    </select>
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="accordion accordion-icon-collapse" id="kt_accordion_3">
                                ...
                                <?php
                                    $sql = "SELECT
                                                NHCAP_ID,
                                                LOWER(CHCAP_NOMBRE) CHCAP_NOMBRE
                                ...
                                <div class="mb-5">
                                    <!--begin::Header-->
                                    <div class="accordion-header py-3 d-flex collapsed" data-bs-toggle="collapse" data-bs-target="#kt_categoria_<?php echo $row["NHCAP_ID"]; ?>">
                                        ...
                                        <h3 class="fs-4 fw-semibold mb-0 ms-4"><?php echo ucwords($row["CHCAP_NOMBRE"]); ?></h3>
                                    </div>
                                    <!--end::Header-->

                                    <!--begin::Body-->
                                    <div id="kt_categoria_<?php echo $row["NHCAP_ID"]; ?>" class="fs-6 collapse ps-10" data-bs-parent="#kt_accordion_3">
                                        ...
                                        <?php
                                            $sql = "SELECT
                                                        ...
                                                        A.NHPRE_ORDEN,
                                                        A.CHPRE_DESCRIPCION 
                                                    FROM SRD_HIG_PREGUNTAS A
                                                    WHERE A.NHPRE_ESTADO = 1 AND A.NAUDI_EST_REG = 1 AND A.NHCAP_ID = " . $row["NHCAP_ID"] . "
                                                    ORDER BY A.NHPRE_ORDEN ASC;";
                                        ...
                                        <div class="fv-row my-5">
                                            ...
                                            <label class="fs-6 fw-semibold mb-6">
                                                <?php echo $row2["NHPRE_ORDEN"] . ". " . $row2["CHPRE_DESCRIPCION"]; ?>
                                            </label>
                                            <!--End::Label-->
                                            ...
                                            <div class="row row-cols-1 row-cols-md-3 row-cols-lg-1 row-cols-xl-3 g-9" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button='true']">
                                                ...
                                                <?php
                                                    $sql = "SELECT
                                                                A.NHPRE_ID,
                                                                A.NHRESP_ID,
                                                                LOWER(B.CHRESP_DESCRIPCION) CHRESP_DESCRIPCION,
                                                                B.NHRESP_VALOR,
                                                                B.CHRESP_ICONO,
                                                                B.CHRESP_CLASE
                                                            FROM SRD_HIG_PREGUNTAS_RPTAS A
                                                            INNER JOIN SRD_HIG_RESPUESTAS B ON A.NHRESP_ID = B.NHRESP_ID
                                                            WHERE A.NHPRE_ID = " . $row2["NHPRE_ID"] . " AND 
                                                                A.NHRPT_ESTADO = 1 AND A.NAUDI_EST_REG = 1 AND
                                                                B.NHRESP_ESTADO = 1 AND B.NAUDI_EST_REG = 1
                                                            ORDER BY B.NHRESP_ORDEN ASC;";
                                                ...
                                                <div class="col">
                                                    ...
                                                    <label class="custom-label btn btn-outline btn-outline-dashed btn-active-light-primary align-items-center d-flex text-start p-6" data-kt-button="true">
                                                        ...
                                                        <span class="form-check form-check-custom form-check-solid form-check-sm align-items-start me-4">
                                                            <input class="form-check-input" type="radio" name="radio_preg_<?php echo $row3["NHPRE_ID"]; ?>" value="<?php echo $row3["NHRESP_ID"]; ?>" />
                                                        </span>
                                                        <!--end::Radio-->
                                                        <span class="symbol symbol-50px me-6">
                                                            <span class="symbol-label bg-light-<?php echo $row3["CHRESP_CLASE"]; ?>">
                                                                <i class="ki-duotone <?php echo $row3["CHRESP_ICONO"]; ?> fs-3x text-<?php echo $row3["CHRESP_CLASE"]; ?>">
                                                        ...
                                                        <!--begin::Info-->
                                                        <span class="me-4">
                                                            <span class="fs-4 fw-bold text-<?php echo $row3["CHRESP_CLASE"]; ?> d-block"><?php echo ucwords($row3["CHRESP_DESCRIPCION"]); ?></span>
                                                        </span>
                                                        <!--end::Info-->
                                                    </label>
                                                    <!--end::Option-->
                ...
                <div id="div-guardar" class="d-flex justify-content-end d-none">
                    <!--begin::Button-->
                    <a type="button" id="kt_cancelar_encuesta"
                        class="btn btn-light me-5">
                        Cancelar
                    </a>
                    <!--end::Button-->
